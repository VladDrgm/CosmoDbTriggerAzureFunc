...
//         services.AddTransient<AppSettings>(provider => provider.GetService<IOptions<AppSettings>>().Value);
//
//         // Create AzureLoggingService singleton with AppSettings
//         services.AddSingleton<AzureLoggingService>(provider => 
//             new AzureLoggingService(provider.GetService<IOptions<AppSettings>>().Value));
//     })
//     .Build();
//
// host.Run();
